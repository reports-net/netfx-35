...
'
'このソース コードは Microsoft.VSDesigner、バージョン 2.0.50727.4952 によって自動生成されました。
'
Namespace ac.pao.www
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927"),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="SampleSoapBinding", [Namespace]:="http://www.pao.ac:8080/axis/Sample.jws")>  _
    Partial Public Class SampleService
        ...
        Private getKoukokuOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = "http://www.pao.ac:8080/axis/Sample.jws"
        ...
        '''<remarks/>
        Public Event getKoukokuCompleted As getKoukokuCompletedEventHandler
        
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace:="http://DefaultNamespace", ResponseNamespace:="http://www.pao.ac:8080/axis/Sample.jws")>  _
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace:="http://DefaultNamespace", ResponseNamespace:="http://www.pao.ac:8080/axis/Sample.jws")>  _
        Public Function getKoukoku() As <System.Xml.Serialization.SoapElementAttribute("getKoukokuReturn", DataType:="base64Binary")> Byte()
            Dim results() As Object = Me.Invoke("getKoukoku", New Object(-1) {})
            Return CType(results(0),Byte())
        End Function
        
        '''<remarks/>
        Public Function BegingetKoukoku(ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("getKoukoku", New Object(-1) {}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndgetKoukoku(ByVal asyncResult As System.IAsyncResult) As Byte()
            Dim results() As Object = Me.EndInvoke(asyncResult)
            Return CType(results(0),Byte())
        End Function
        
        '''<remarks/>
        Public Overloads Sub getKoukokuAsync()
            Me.getKoukokuAsync(Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub getKoukokuAsync(ByVal userState As Object)
            If (Me.getKoukokuOperationCompleted Is Nothing) Then
                Me.getKoukokuOperationCompleted = AddressOf Me.OngetKoukokuOperationCompleted
            End If
            Me.InvokeAsync("getKoukoku", New Object(-1) {}, Me.getKoukokuOperationCompleted, userState)
        End Sub
        
        Private Sub OngetKoukokuOperationCompleted(ByVal arg As Object)
            If (Not (Me.getKoukokuCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent getKoukokuCompleted(Me, New getKoukokuCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927")>  _
    Public Delegate Sub getKoukokuCompletedEventHandler(ByVal sender As Object, ByVal e As getKoukokuCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.4927"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class getKoukokuCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
